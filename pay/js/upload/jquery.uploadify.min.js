...
(function (c) {
	var b = {init:function (d, e) {
		return this.each(function () {
			var n = c(this);
			var m = n.clone();
			var j = c.extend({id:n.attr("id"), swf:"uploadify.swf", uploader:"uploadify.php", auto:true, buttonClass:"", buttonCursor:"hand", buttonImage:null, buttonText:"SELECT FILES", checkExisting:false, debug:false, fileObjName:"Filedata", fileSizeLimit:0, fileTypeDesc:"All Files", fileTypeExts:"*.*", height:30, itemTemplate:false, method:"post", multi:true, formData:{}, preventCaching:true, progressData:"percentage", queueID:false, queueSizeLimit:999, removeCompleted:true, removeTimeout:1, requeueErrors:false, successTimeout:30, uploadLimit:0, width:120, overrideEvents:[]}, d);
			...
			if (h) {
				...
				n.data("uploadify", i);
				var l = c("<div />", {id:j.id, "class":"uploadify", css:{height:"10px", width:"370px"}});
				c("#" + i.movieName).wrap(l);
				l = c("#" + j.id);
				l.data("uploadify", i);
				var f = c("<div />", {id:j.id + "-button", "class":j.buttonClass});
				if (j.buttonImage) {
		...
		if (c.inArray("onSelectError", e.overrideEvents) < 0) {
			switch (g) {
			  ...
			  case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
				this.queueData.errorMsg += "\n\u6587\u4ef6 \"" + d.name + "\" \u8d85\u51fa\u6700\u5927\u9650\u5236 (" + e.fileSizeLimit + ").";
				break;
