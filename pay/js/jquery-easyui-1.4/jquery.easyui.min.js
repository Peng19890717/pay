...
var t=$(_c3);
return $.extend({},$.parser.parseOptions(_c3,[{total:"number",pageSize:"number",pageNumber:"number",links:"number",headerContextMenu:""},{loading:"boolean",showPageList:"boolean",showRefresh:"boolean"}]),{pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined)});
};
...
$.fn.panel.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,tools:null,queryParams:{},method:"get",href:null,loadingMessage:"页面载入中...",loader:function(_251,_252,_253){
...
},onLoadSuccess:function(){$(this).datagrid('fixRownumber');
},onLoadError:function(){topCenterMessage('1','数据加载失败！');
...
},onHeaderContextMenu:function(e,_77b){e.preventDefault();if (!this.headerContextMenu)this.headerContextMenu = createColumnMenu(this.id);this.headerContextMenu.menu('show', {left:e.pageX,top:e.pageY});
...
return $(_E987).datebox("options").cleanText;
},handler:function (_986) {
$(_986).datebox("setValue","");
