...
import com.third.jingdongdaifu.wangyin.util.Base64;
import com.third.jingdongdaifu.wangyin.util.DES;
import com.third.jingdongdaifu.wangyin.util.SignUtils;
...
public class EnctyptUtil {
	 ...
	 * @throws Exception 
	 */
	private static final Log log = LogFactory.getLog(EnctyptUtil.class);
	public static String signEnvelop(Map<String,String> map,String password,String pirFilePath,String pubFilePath) throws Exception{
		...
		log.info("京东代付业务参数原始报文:"+link);
		//System.out.println("业务参数原始报文:"+link);
