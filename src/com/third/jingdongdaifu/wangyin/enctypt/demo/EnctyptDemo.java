package com.third.jingdongdaifu.wangyin.enctypt.demo;
...
//		paramMap.put("trade_type", "T_AGD");
	...
	private static void accountQuery(){
		...
		paramMap.put("out_trade_no","23456521837692");
	...
	private static Map<String,String> init(){
		 ...
		 map.put("customer_no","360080004001463150");//会员号。
		 map.put("request_datetime",request_datetime);
		 map.put("out_trade_no",String.valueOf(System.currentTimeMillis()));//商户订单号。
		 map.put("trade_amount","100");//交易金额。单位分。
		 map.put("trade_currency","CNY");//交易币种。
		 map.put("trade_subject","test代付");//交易描述。
		 map.put("pay_tool","TRAN");//TRAN代付到银行卡。
		 map.put("payee_bank_code","ABC");//收款银行编码
		 ...
		 map.put("payee_account_no","6217000010074078455");//收款帐户号
		 map.put("payee_account_name","张志国");//收款帐户名称
		 map.put("notify_url","http://www.baidu.com");//商户处理数据的异步通知地址
