...
public class RSAUtils {
     ...
     * @return
     */
    public static boolean verify(String source, String sign,String public_key,String charset) throws Exception {
        byte[] digest = sha1(source.getBytes(charset));
        byte[] encryptData = decryptByPublicKey(Base64.decode(sign), public_key);
     ...
     * @return
     */
    public static String encrypt(String paramstr,String charset,String public_key) {
        try {
            byte[] cipherData = RSAUtils.encryptByPublicKey(paramstr.getBytes(charset), public_key);
     ...
     */
    public static String decrypt(String cipherData,String private_key,String charset) {
        try {
