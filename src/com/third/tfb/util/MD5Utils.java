...
public class MD5Utils {
     ...
     * @throws Exception
     */
    public static String sign(String paramSrc,String key,String charset) {
        String sign = md5(paramSrc + "&key=" + key,charset);
     ...
     * @return
     */
    public static boolean verify(String source, String tfbSign,String key,String charset) {
        String sign = md5(source + "&key=" + key,charset);
