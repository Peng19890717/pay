...
public class RSAUtil {
	...
	public static final String GC_PUBLIC_KEY_PAT = PayConstant.PAY_CONFIG.get("TFB_DF_RSA_PUBLIC_KEY");     //国采提供的公钥key

	public static final String PRIVATE_KEY_PAT = PayConstant.PAY_CONFIG.get("TFB_DF_RSA_PRIVATE_KEY");    //这里要换成自已的私钥key
	...
	public static final String MD5_KEY = PayConstant.PAY_CONFIG.get("TFB_WG_MD5_KEY");    //测试环境MD5 key
