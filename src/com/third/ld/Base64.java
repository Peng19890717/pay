...
public class Base64 {
	private static final int BASELENGTH = 255;
	  ...
	  public static String doBase64URLEncode(String src) throws Exception{
	    try
	    {
	      ...
	      return doURLEncode(base64data);
	    } catch (Exception e) {
	    }
	    throw new Exception("src进行Base64解码失败");
	  }
	  ...
	  public static String doBase64URLDecode(String src) throws Exception{
	    try
	    {
	      src = doURLDecode(src);
	      BASE64Decoder decoder = new BASE64Decoder();
	      byte[] raw = decoder.decodeBuffer(src);
	      return new String(raw); } catch (Exception e) {
	    }
	    throw new Exception("src进行Base64解码失败");
	  }

	  public static String doBase64URLDecode(String src, String enc) throws Exception{
