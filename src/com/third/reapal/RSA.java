...
public class RSA {
     ...
     * @return KeyStore
     */
    public static KeyStore getKsformPfx(String certPath, String certPassword)
            throws Exception {
    ...
    public static void main(String [] args) throws Exception{
    	getKsformPfx("D:\\Java\\apache-tomcat-7.0.30\\webapps\\pay\\config\\rb_merchant.pfx","abc123");
    }
    /**
     * 通过PFX文件获得别名
     *
