 ...
 * 扫码请求数据
 */
public class WechatScannedNotify{
	...
	public WechatScannedNotify() {
		
	}

	public WechatScannedNotify(String key, String return_code, String return_msg, String appid, String mch_id,
