...
import com.pay.account.service.PayGeneralLedgerHisService;
import com.pay.account.dao.PayGeneralLedgerHis;
@Controller
public class PayGeneralLedgerHisController {
    @RequestMapping("payGeneralLedgerHis")
    public String getPayGeneralLedgerHisList(HttpServletRequest request,HttpServletResponse response,
            @ModelAttribute("payGeneralLedgerHis") PayGeneralLedgerHis payGeneralLedgerHis) {
        ...
        new Blog(this.getClass().getSimpleName()+".getPayGeneralLedgerHisList","取得PayGeneralLedgerHis列表",user.id,request);
        OutputStream os = null;
        try {
            if(flag == null)return "/jsp/pay/account/pay_general_ledger_his.jsp";
            ...
            os.write(new PayGeneralLedgerHisService().getPayGeneralLedgerHisList(payGeneralLedgerHis,page,rows,
