 ...
 */
@Controller
public class FYNotifyController {
	private static final Log log = LogFactory.getLog(FYNotifyController.class);
    /**
     * 通知地址(直连网银)
     * @param request
     * @param response
    ...
    @RequestMapping("FYQuickPayNotify")
    public String FYQuickPayNotify(HttpServletRequest request,HttpServletResponse response) {
    	...
    	try {
    		 ...
    		 * TYPE+"|"+VERSION+"|"+RESPONSEC
				...
				KCARD+"|"+"商户 32 位密钥key"
    		 */
    		String sing_temp=FYMD5.MD5Encode(type+"|"+version+"|"+responsecode+"|"+mchntcd+"|"+mchntorderid+"|"+orderid+"|"+amt+"|"+bankcard+"|"+PayConstant.PAY_CONFIG.get("fy_quickPay_key"));
