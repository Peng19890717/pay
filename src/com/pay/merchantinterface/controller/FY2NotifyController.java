 ...
 */
@Controller
public class FY2NotifyController {
	private static final Log log = LogFactory.getLog(FY2NotifyController.class);
    /**
     * 通知地址(直连网银)
     * @param request
     * @param response
    ...
    public String FYNotify(HttpServletRequest request,HttpServletResponse response) {
        ...
        try {
        	...
        	String mchnt_key= PayConstant.PAY_CONFIG.get("fy_mchnt_key2");
        	//md5摘要。
    ...
    @RequestMapping("FY2QuickPayNotify")
    ...
    log.info("富有快捷异步通知.............................");
    	try {
    		 ...
    		 * TYPE+"|"+VERSION+"|"+RESPONSEC
				...
				KCARD+"|"+"商户 32 位密钥key"
    		 */
    		String sing_temp=FYMD5.MD5Encode(type+"|"+version+"|"+responsecode+"|"+mchntcd+"|"+mchntorderid+"|"+orderid+"|"+amt+"|"+bankcard+"|"+PayConstant.PAY_CONFIG.get("fy_quickPay_key2"));
