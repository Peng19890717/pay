...
public class PayAccProfile {
    ...
    public Long consAcBal = 0l;
    public Long minStlBalance = 0l;
    public Long frozBalance = 0l;
    public String glCode;
    public String acStatus = "0";
    public String listStsFlg = "1";
    public String resvFlg;
    public Long accSumNum = 0l;
    public Date lstTxTime = new Date();
    public String getId(){
         return id;
    }
